...
#Code is still for modifications (i.e., usage of relative paths, creation of function, #retrieving of desired data at once, creation of excel file as output, download attachment etc.)